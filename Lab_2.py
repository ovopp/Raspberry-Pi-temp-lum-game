...
#Thermometer
Label(window, text="50*C/112*F").grid(row = 5, column=1, padx = 5, pady = 1) #High temp label
s = ttk.Style()
s.theme_use('clam')
...
therm["maximum"] = 50
Label(window, text="0*C/32*F").grid(row = 11, column=1, padx = 1, pady = 1) #Low temp label
